...
const Payment = () => {
  return (
    ...
    <div className='mt-32 container mx-w-[1440px] mx-h-[2240px] mx-auto flex flex-col-reverse lg:flex-row gap-8 space-y-8 '>

    <div className="left-section w-[880px] h-[2176px] shadow-lg rounded-lg space-y-8 p-7">

 {/* Billing section */}
<div className="w-full max-w-[852px] h-auto bg-white rounded-xl shadow-md p-6 lg:p-8 mx-auto">
  {/* Header */}
...
{/* Payment method */}
          ...
          <div>
            ...
            <p className="text-[#90A3BF] text-[14px] font-medium">
              We are using the most advanced security to provide you the best experience ever.
                    ...
                    <div className="right-section w-full max-w-[327px] lg:max-w-[492px] bg-white rounded-lg shadow-lg p-4 sm:p-6">
  {/* Header */}
  ...
  {/* Promo Code Section */}
  <div className="mb-4 lg:mb-6 flex flex-col sm:flex-row items-center gap-4">
    <input
      type="text"
