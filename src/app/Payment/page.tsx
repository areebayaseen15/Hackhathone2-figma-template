  ...
  return (
    ...
    >
      <div className=" w-[295px] lg:w-[852px] xl:mx-w-[700px] mx-h-[2176px] lg:h-auto  rounded-lg space-y-8 p-7">
        {/* Billing section */}
        <div className="flex flex-col place-content-center gap-20 xl:gap-10 ">
          <div className="w-[327px] h-[516px] md:w-[720px] lg:w-[852px] xl:w[800px] lg:h-auto bg-white rounded-xl shadow-md p-6 lg:p-8">
          ...
          {/* Rental info */}
          <div className="w-[327px] h-[816px] md:w-[720px] lg:w-[852px] lg:h-auto bg-white rounded-xl shadow-md p-6 lg:p-8">
            ...
            <div className="mb-6">
              <div className="flex items-center mb-4">
                <input
                  ...
                  readOnly
                />
                <label className="ml-3 text-sm font-medium text-gray-800">
                  Pick – Up
                </label>
              </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      type="text"
                      placeholder="Select your time"
                      className="w-full h-12 px-4 bg-gray-100 rounded-lg text-gray-700 focus:outline-none focus:ring-2
           focus:ring-blue-500"
                    />
                    <FaChevronDown className="absolute right-4 top-1/2 transform -translate-y-1/2 text-gray-500" />
                  </div>
          ...
          <div
            className="w-[327px] mx-h-[732px] md:w-[720px] md:h-auto lg:w-[852px] lg:h-[596px] bg-white
     rounded-xl shadow-md p-8"
          ...
          <div className="w-[327px] mx-h-[476px] md:w-[720px] lg:w-[852px] lg:h-[484px] bg-[#FFFFFF] rounded-lg shadow-lg p-8">
            {/* Header */}
            <div className="flex justify-between items-center mb-6">
              <div>
              ...
              <span className="text-[#90A3BF] texty-12px] lg:text-[16px] font-medium">
                Step 4 of 4
              </span>
            </div>
            ...
            <div className="space-y-4 mb-8 text-base font-semibold text-[#1F2544]">
              <label className="flex items-center bg-[#F6F7F9] p-4 rounded-lg cursor-pointer">
                <input
                  type="checkbox"
                  className="form-checkbox w-5 h-5 border-[#90A3BF] mr-4"
                />
            ...
            <div className="flex flex-col items-start gap-4">
              <Link href="/Dashboard">
                <button className="w-[116px] h-[48px] bg-[#3563E9] text-white text-[16px] font-medium rounded-lg hover:bg-[#274bb8] mb-4">
                  Rent Now
                </button>
              </Link>
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-[#1A202C] font-semibold text-base">
      ...
      <div
        className="mx-auto right-section md:w-[720px] max-w-[327px] lg:max-w-[492px] lg:h-[560px]
      bg-white rounded-lg shadow-lg p-4 sm:p-6 xl:mr-10"
      >
